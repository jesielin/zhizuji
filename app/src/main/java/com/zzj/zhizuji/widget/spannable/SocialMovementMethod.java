package com.zzj.zhizuji.widget.spannable;
 ...
 * @date 16/1/2 16:54
 */
public class SocialMovementMethod extends BaseMovementMethod {
    public final String TAG = SocialMovementMethod.class.getSimpleName();
     ...
     */
    public SocialMovementMethod(int clickableSpanBgClor){
     ...
     */
    public SocialMovementMethod(int clickableSpanBgClor, int textViewBgColor){
