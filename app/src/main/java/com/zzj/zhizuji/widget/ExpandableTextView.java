package com.zzj.zhizuji.widget;
...
import com.zzj.zhizuji.widget.spannable.SocialMovementMethod;


public class ExpandableTextView extends LinearLayout implements View.OnClickListener {

    private static final String expandText = "收起";
    private static final String collapsedText = "全文";
...
//    private int mPosition;
    ...
    public void onClick(View view) {
        ...
        mButton.setText(mCollapsed ? collapsedText : expandText);
...
//        mTv.setOnClickListener(this);
        mTv.setMovementMethod(new SocialMovementMethod());
