package zzj.com.zhizuji.widget;
...
import zzj.com.zhizuji.widget.spannable.SocialMovementMethod;
...
public class CommentListView extends LinearLayout {
    ...
    protected void initAttrs(AttributeSet attrs) {
        ...
        try {
            //textview的默认颜色
            itemColor = typedArray.getColor(R.styleable.PraiseListView_item_color, getResources().getColor(R.color.md_red_A700));
            itemSelectorColor = typedArray.getColor(R.styleable.PraiseListView_item_selector_color, getResources().getColor(R.color.md_light_green_A700));
    ...
    private View getView(final int position){
        ...
        final SocialMovementMethod socialMovementMethod = new SocialMovementMethod(itemSelectorColor, itemSelectorColor);

        final CommentItem bean = mDatas.get(position);
        String name = bean.commenterUUID;
        String id = bean.commenterUUID;
        String toReplyName = "";
        if (bean.targetCommenterUUID != null) {
        ...
        commentTv.setMovementMethod(socialMovementMethod);
        commentTv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (socialMovementMethod.isPassToTv()) {
